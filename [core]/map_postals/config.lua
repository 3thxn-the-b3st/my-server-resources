...
extraTiles = {
    ...
    [1] = {xOffset = 0, yOffset = 1, txd = "minimap_roxwood_1", txn = "extra_tile_1"},
	[2] = {xOffset = -1, yOffset = 1, txd = "minimap_roxwood_2", txn = "extra_tile_1"},
	[3] = {xOffset = -1, yOffset = 0, txd = "minimap_roxwood_3", txn = "extra_tile_1"},
}
